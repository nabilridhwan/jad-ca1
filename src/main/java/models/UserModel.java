...
public class UserModel {
	...
	public static IDatabaseUpdate insertNewUser(String name, String email, String password, String address_1,
			String address_2, String apt_suite, String postal_code, String phone) {
		// Default profile picture image
		return insertNewUser(name, email, password, "https://via.placeholder.com/400", address_1, address_2, apt_suite,
				postal_code, phone);
	}

	public static IDatabaseUpdate insertNewUser(String name, String email, String password, String pfpImg,
			String address_1, String address_2, String apt_suite, String postal_code, String phone) {
		return databaseConnection -> {
			Connection conn = databaseConnection.get();
			try {
				PreparedStatement prepStatement = conn.prepareStatement(
						"INSERT INTO user(full_name, email, password, profile_pic_url, address_1, address_2, apt_suite, postal_code, phone) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?)");
	...
	public static IDatabaseUpdate updateUser(int userId, String profile_pic_url, String fullName, String email,
			String password, String address_1, String address_2, String apt_suite, String postal_code, String phone,
			String role) {
		return databaseConnection -> {
...
//            SQL Reference "UPDATE user SET full_name = ?, email = ?, password = ?, profile_pic_url = ? WHERE user_id = ?";
			...
			Connection conn = databaseConnection.get();
			try {
				PreparedStatement prepStatement = conn.prepareStatement("UPDATE user " + "SET " + "profile_pic_url = ?,"
						+ "full_name = ?," + "email = ?," + "password =?, " + "address_1 = ?," + "address_2 = ?,"
						+ "apt_suite = ?," + "postal_code = ?," + "phone = ?," + "role = ?" + "WHERE user_id = ?");
				...
				prepStatement.setString(9, phone);
				prepStatement.setString(10, role);
	...
	public static IDatabaseUpdate updateUser(int userId, String profile_pic_url, String fullName, String email,
			String address_1, String address_2, String apt_suite, String postal_code, String phone, String role) {
		return databaseConnection -> {
//            SQL Reference "UPDATE user SET full_name = ?, email = ?, password = ?, profile_pic_url = ? WHERE user_id = ?";
			...
			try {
				PreparedStatement prepStatement = conn.prepareStatement("UPDATE user " + "SET " + "profile_pic_url = ?"
						+ "full_name = ?," + "email = ?," + "address_1 = ?," + "address_2 = ?," + "apt_suite = ?,"
						+ "postal_code = ?," + "phone = ?," + "role = ?" + "WHERE user_id = ?");
				...
				prepStatement.setString(9, role);
