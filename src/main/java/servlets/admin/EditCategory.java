...
//			Redirect to the home page
		...
		if ((contentType.indexOf("multipart/form-data") >= 0)) {
			...
			if (image_url != null) {
				affectedRows = CategoryModel.updateCategory(category_id, image_url, category_name, category_desc)
						.update(connection);
			} else {
				affectedRows = CategoryModel.updateCategory(category_id, category_name, category_desc)
						.update(connection);
			}
...
//			page redirection
				...
				response.sendRedirect(
						"/CA1-Preparation/views/admin/edit_category.jsp?message=Category with that name already exists!");
				return;
			}
