...
//new tours won't be able to see this.
                            %>
								...
								<div class="col-lg-12 my-3">
									<a
										href="./edit_tourCategories.jsp?tourId=<%=tour.getTour_id()%>"
										class="btn btn-primary"> Edit Categories </a>
								</div>

								<h4>Tour Images</h4>
								<div class="col-lg-12 my-3">
									<a
										href="./edit_tourImages.jsp?tourId=<%=tour.getTour_id()%>&tourImageId=new"
									...
									<div class="destination">
										<div class="text p-3">
											...
											<div class="row my-3">
												<div class="col-md-12">
													<a
														href="./edit_tourImages.jsp?tourId=<%=tour.getTour_id()%>&tourImageId=<%=image.getId()%>"
														class=" btn btn-primary w-100 mb-1"> Edit </a> <a
														href="./edit_tourImages.jsp?tourId=<%=tour.getTour_id()%>&tourImageId=<%=image.getId()%>&delete="
								...
								<div class="col-lg-12 my-3">
									<a
										href="./edit_tourDates.jsp?tourId=<%=tour.getTour_id()%>&tourDateId=new"
										class="btn btn-primary"> Add Tour Date </a>
								</div>
									...
									<div class="destination">
										<div class="text p-3">
											...
											<p class="bottom-area d-flex">
												<span><i class="icon-map-o"></i> Slots <%=date.getAvail_slot() %>/<%=date.getMax_slot()%></span>
											</p>
											<div class="row my-3">
												<div class="col-md-12">
													<a
														href="./edit_tourDates.jsp?tourId=<%=tour.getTour_id()%>&tourDateId=<%=date.getId()%>"
                                                ...
                                                -->
													...
													<a
														href="./edit_tourDates.jsp?tourId=<%=tour.getTour_id()%>&tourDateId=<%=date.getId()%>&delete="
														class="btn btn-secondary w-100"> Delete </a>
												</div>
											</div>
										</div>
								...
								<form action="${pageContext.request.contextPath}/editTour"
									method="POST">
									...
									<div class="form-group">
										...
										<input type="text" class="form-control"
											placeholder="Tour Name" name="name"
									...
									<div class="form-group">
										...
										<input type="text" class="form-control"
											placeholder="Brief Description" name="bDesc"
									...
									<div class="form-group">
										...
										<input type="text" class="form-control"
											...
											value="<%=tour.getTour_desc()%>" required />

									</div>
									<div class="form-group">

										<input type="text" name="location" class="form-control"
											placeholder="Location" value="<%=tour.getTour_location()%>"
											required />
