...
<body>
	...
	int userID = Util.forceAdmin(session, response);

	String tourDateId = request.getParameter("tourDateId");
	String transaction_id = request.getParameter("transaction_id");

	if (transaction_id == null || tourDateId == null) {
					...
					<div class="container px-5">
						<div class="row d-flex contact-info">
							<div class="col-md-12 mb-4 text-center">
								<h2 class="h3 font-weight-bold">Admin Transaction Details</h2>
							</div>
							<div class="w-100"></div>
						</div>
