...
<body>
	...
	<div class="hero-wrap"
		style="background-image: url('${pageContext.request.contextPath}/images/bg_2.jpg'); padding-top: 70px;">
				...
				<section
					...
					<div class="container px-5">
						...
						<div class="row block-9">
							<div class="col-md-12">
								<!-- FORM -->
								<form action="${pageContext.request.contextPath}/admin_add_user"
									method="POST">
									...
									<div class="form-group">
										<input type="text" class="form-control"
											placeholder="Address 1" required name="address_1"
											value="<%=address_1%>" />
									</div>

									<div class="form-group">
										<input type="text" class="form-control"
											placeholder="Address 2" required name="address_2"
											value="<%=address_2%>" />
									</div>

									<div class="form-group">
										<input type="text" class="form-control"
											placeholder="Apt/Suite" required name="apt_suite"
											value="<%=apt_suite%>" />
									</div>
