            ...
            <div class="col-sm col-md-2 ftco-animate">
                <div class="item">
                    <div class="destination">
                        ...
                        <div class="row my-3">
                            <div class="col-md-12">
                                <a href="${pageContext.request.contextPath}/views/admin/edit_category.jsp?id=<%=id %>"
                                   class="btn btn-primary w-100 mb-1">
                                    Edit
                                </a>

                                <a href="${pageContext.request.contextPath}/deleteCategory?id=<%=id %>"
...
<%--                                                (<%=reviews.length%> review(s))--%>
                        ...
                        <p class="bottom-area d-flex">
                         ...
                         <div class="row my-3">
                                <div class="col-md-12">
                                    <a href="userRegistrations.jsp?tourId=<%=tour_id%>" class="btn btn-primary w-100  mb-1">
                                    ...
                                    <a href="./edit_tour.jsp?tourId=<%=tour_id%>&delete="
                                       class="btn btn-secondary w-100">
                                        Delete
                                    </a>
                                </div>
