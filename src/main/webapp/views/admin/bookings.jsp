                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a class="btn btn-primary"
                                       href="${pageContext.request.contextPath}/views/admin/transaction_details.jsp?tourDateId=<%=tourRegistration.getTour_date_id() %>&transaction_id=<%=tourRegistration.getStripe_transaction_id()%>">
