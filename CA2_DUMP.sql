...
CREATE TABLE `stripe_customer` (
  ...
  CONSTRAINT `fk_stripe_user_id` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`)
...
LOCK TABLES `stripe_customer` WRITE;
/*!40000 ALTER TABLE `stripe_customer` DISABLE KEYS */;
INSERT INTO `stripe_customer` VALUES ('cus_M61EbJnYU99YBU',1);
/*!40000 ALTER TABLE `stripe_customer` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `tour_category` VALUES (1,1,1),(2,2,1),(3,3,1),(4,5,1),(5,6,1),(6,7,1),(7,8,1),(8,9,1),(9,1,2),(10,2,2),(11,3,2),(12,4,2),(13,5,2),(14,1,3),(15,2,3),(16,3,3),(17,4,3),(18,5,3),(19,6,3),(20,7,3),(21,8,3),(22,9,3);
...
INSERT INTO `tour_date` VALUES (1,1,'2022-06-29 08:00:00','2022-06-29 22:00:00',1,69,8,50),(2,2,'2022-06-29 08:00:00','2022-06-29 22:00:00',1,34,13,50),(3,3,'2022-06-29 08:00:00','2022-06-29 22:00:00',1,26,10,50),(5,5,'2022-06-29 08:00:00','2022-06-29 22:00:00',1,12,12,50),(6,6,'2022-06-29 08:00:00','2022-06-29 22:00:00',1,49.9,3,20),(7,7,'2022-06-29 08:00:00','2022-06-29 22:00:00',1,49.9,6,20),(8,8,'2022-06-29 08:00:00','2022-06-29 22:00:00',1,49.9,2,20),(9,9,'2022-06-29 08:00:00','2022-06-29 22:00:00',1,49.9,5,20),(10,1,'2022-06-30 08:00:00','2022-06-30 22:00:00',1,69,14,50),(11,1,'2022-07-01 08:00:00','2022-07-01 22:00:00',1,69,25,50),(12,10,'2022-06-26 09:00:01','2022-06-27 12:00:01',1,25,60,60),(13,4,'2022-06-26 11:39:00','2022-06-26 11:39:00',1,45,51,60);
...
INSERT INTO `tour_registration` VALUES (5,3,13,3,'','2022-07-20 11:04:20'),(6,85,13,2,'','2022-07-20 11:04:20'),(7,85,13,2,'','2022-07-20 11:04:20'),(8,85,13,2,'','2022-07-20 11:04:20'),(9,85,8,2,'','2022-07-20 11:04:20');
...
INSERT INTO `tour_tour_image` VALUES (2,2,5),(3,3,2),(4,4,6),(5,5,7),(6,6,8),(7,7,9),(8,8,10),(9,9,11),(10,10,3),(11,1,4);
...
INSERT INTO `user` VALUES (1,'Admin Amy','https://i.pinimg.com/736x/0b/09/cc/0b09cc0b7340b7ed9ca3f96897eac7c5.jpg','amy@admin.com','$2a$10$1SbsG94jz3fCAZzBZqo/Ye5x4ES7slFmHrpI/4B7x61CLvrFqlCxC','admin','00000000','','','','','2022-07-21 12:08:07'),(3,'Nabil','https://via.placeholder.com/400','nabil@test.com','$2a$10$1SbsG94jz3fCAZzBZqo/Ye5x4ES7slFmHrpI/4B7x61CLvrFqlCxC','admin','00000000','','','','','2022-07-21 12:08:07'),(78,'test','https://via.placeholder.com/400','test@test.com','$2a$10$1SbsG94jz3fCAZzBZqo/Ye5x4ES7slFmHrpI/4B7x61CLvrFqlCxC','user','00000000','','','','','2022-07-21 12:08:07'),(83,'TestUser1','https://via.placeholder.com/400','testuser1@gmail.com','$2a$10$1SbsG94jz3fCAZzBZqo/Ye5x4ES7slFmHrpI/4B7x61CLvrFqlCxC','user','00000000','','','','','2022-07-21 12:08:07'),(85,'UwU','https://c.tenor.com/kiBbs5cxnmYAAAAC/pusheen-cat.gif','blazing.arrow46@gmail.com','$2a$10$1SbsG94jz3fCAZzBZqo/Ye5x4ES7slFmHrpI/4B7x61CLvrFqlCxC','user','00000000','','','','','2022-07-21 12:08:07'),(86,'Nabil','https://via.placeholder.com/400','nabridhwan@gmail.com','$2a$10$epE8OsuVVmnwIYQbGw.60OyNOdozHJaZvHBVRBYXkjxGpRoQbKcxG','admin','00000000','','','','','2022-07-21 12:08:07'),(88,'TestingUser','https://via.placeholder.com/400','testing_user@test.com','$2a$10$1SbsG94jz3fCAZzBZqo/Ye5x4ES7slFmHrpI/4B7x61CLvrFqlCxC','user','87400400','265 Bits Road','Street 12','#01-256','640256','2022-07-21 12:08:47');
...
INSERT INTO `wishlist` VALUES (4,1,4);
...
-- Dump completed on 2022-07-21 20:33:21
